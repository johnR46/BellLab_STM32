...
int setFileName[] = {0x00, 0x57, 0xab, 0x2f,0x2f,0x41,0x56,0x2E,0x74,0x78,0x74,0x00};
...
int FileWrite[] = {0x00, 0x57, 0xab, 0x2d,0x6a,0x6f,0x68,0x6e,0x20,0x6c,0x6f,0x76,0x65,0x20,0x6d,0x69,0x78};
int FileLength[] = {0x00, 0x57, 0xab, 0x3c, 0x0d, 0x00};
...
void searchFile() {
  ...
  while (seaching == 1) {
    ...
    /*if(endFileName&&SwitchEndFileName==0&&command_>=11){
      SwitchEndFileName = 1;
      printf("EndFileName\r\n");
      }*/
  }
